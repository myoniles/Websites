...
parser.add_argument("-t","--template", action="store", dest="template", default="template.html", help="If, \"-n\" option is selected, chooses the new template the html doc will be based on")
